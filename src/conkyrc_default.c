...
void conkyrc_default () {
  ...
  if (set_network == True) {
    ...
    fprintf(fp,"# |--%s\n", wlan);
    fprintf(fp,"${if_up %s}\n", wlan);
    fprintf(fp,"${voffset -5}${color0}${font ConkyColors:size=15}s${font}${color}${goto %d}${voffset -12}%s: ${font Liberation Sans:style=Bold:size=8}${color1}${upspeed %s}${color}${font} ${alignr}${color2}${upspeedgraph %s 8,60 %s}${color}\n", go2, up, wlan, wlan, color4);
    fprintf(fp,"${goto %d}%s: ${font Liberation Sans:style=Bold:size=8}${color2}${totalup %s}${color}${font}\n", go2, total, wlan);
    fprintf(fp,"${voffset 2}${color0}${font ConkyColors:size=15}t${font}${color}${goto %d}${voffset -12}%s: ${font Liberation Sans:style=Bold:size=8}${color1}${downspeed %s}${color}${font} ${alignr}${color2}${downspeedgraph %s 8,60 %s}${color}\n", go2, down, wlan, wlan, color4);
    fprintf(fp,"${goto %d}%s: ${font Liberation Sans:style=Bold:size=8}${color2}${totaldown %s}${color}${font}\n", go2, total, wlan);
    fprintf(fp,"${color0}${font ConkyColors:size=15}j${font}${color}${voffset -6}${goto %d}%s: ${font Liberation Sans:style=Bold:size=8}${color1}${wireless_link_qual_perc %s}%%${color}${font} ${alignr}${color2}${wireless_link_bar 8,60 %s}${color}\n", go2, sinal, wlan, wlan);
    fprintf(fp,"${voffset 2}${color0}${font ConkyColors:size=15}B${font}${color}${goto %d}${voffset -6}%s: ${alignr}${color2}${addr wlan%d}${color}\n", go2, localip, wlan);
    fprintf(fp,"# |--%s\n", eth);
    fprintf(fp,"${else}${if_up %s}\n", eth);
    fprintf(fp,"${voffset -5}${color0}${font ConkyColors:size=15}s${font}${color}${goto %d}${voffset -12}%s: ${font Liberation Sans:style=Bold:size=8}${color1}${upspeed %s}${color}${font} ${alignr}${color2}${upspeedgraph %s 8,60 %s}${color}\n", go2, up, eth, eth, color4);
    fprintf(fp,"${goto %d}%s: ${font Liberation Sans:style=Bold:size=8}${color2}${totalup %s}${color}${font}\n", go2, total, eth);
    fprintf(fp,"${voffset 2}${color0}${font ConkyColors:size=15}t${font}${color}${goto %d}${voffset -12}%s: ${font Liberation Sans:style=Bold:size=8}${color1}${downspeed %s}${color}${font} ${alignr}${color2}${downspeedgraph %s 8,60 %s}${color}\n", go2, down, eth, eth, color4);
    fprintf(fp,"${goto %d}%s: ${font Liberation Sans:style=Bold:size=8}${color2}${totaldown %s}${color}${font}\n", go2, total, eth);
    fprintf(fp,"${voffset 4}${color0}${font ConkyColors:size=15}B${font}${color}${goto %d}${voffset -6}%s: ${alignr}${color2}${addr %s}${color}\n", go2, localip, eth);
    fprintf(fp,"# |--PPP%d\n", ppp);
